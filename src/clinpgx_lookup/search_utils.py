...
def general_search_comma_list(df: pd.DataFrame, query: str, column_name: str, id_column: str, threshold: float = 0.8, top_k: int = 5, keep_columns: Optional[List[str]] = None) -> List[str]:
    """
    Takes a dataframe and returns the top_k matches for the query based on the column_name and id_column.
